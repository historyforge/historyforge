...
Devise.setup do |config|
  ...
  # config.secret_key = '0daa2fd79c37ae77d590d4763f55ede214e736db64f34c6ed0c0f610f70b903516554fe409de10325f150c2b3492f58869b0508115efcf9b7c31bfb25646cda1'
  ...
  config.mailer_sender = proc { "HistoryForge <#{AppConfig[:mail_from]}>" }
  ...
  config.omniauth :facebook, ENV.fetch('FACEBOOK_LOGIN_APP_ID', nil),  ENV.fetch('FACEBOOK_LOGIN_SECRET', nil)
