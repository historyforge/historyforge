# not freezing string literal because the premise of this pile of code is to build up string literals

# This module handles the question mark bubbles on the census forms. It started innocently enough but then each
# year started getting subtly different labels for the same field as other years. So most of the methods became a
# tangled mess of if-else statements.
#
# HF staff and volunteers are working on a new unified lexicon. When that is available, its implementation will
# replace this mess completely. So don't waste any time refactoring this garbage until that lexicon is ready!
module CensusHintsHelper
  def sheet_hint
  ...
  def last_name_hint
    ...
    html << if is_1920?
              image_pack_tag('media/images/1920/names.png')
            elsif is_1940?
              image_pack_tag('media/images/1940/names.png')
            else
              image_pack_tag('media/images/1910/names.png')
            end
    raw html
  end
