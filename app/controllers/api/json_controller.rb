module Api
  class JsonController < ApplicationController
    ...
    def make_building(record,year) #should this have a record.nil? check like  the make methods for doc,narrative,photo,audio,video?
      ...
      return if record.census1920_records.empty? && year == '1920'
      return if record.census1910_records.empty? && year == '1910'
    ...
    def search_documents(search)
      ...
      Document.where(documents_query, search: "%#{search}%").uniq
    end
