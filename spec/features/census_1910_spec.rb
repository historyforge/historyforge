...
RSpec.describe '1910 US Census' do
  scenario 'record life cycle' do
    ...
    visit new_census1910_record_path
    expect(page).to have_content('New 1910 Census Record')
    ...
    visit census1910_record_path(record)
